...
class Menu extends qinpel_cps_1.QinColumn {
    constructor() {
        super();
        this.qinRegion = new qinpel_cps_1.QinButton({
            icon: new qinpel_cps_1.QinIcon(qinpel_cps_1.QinAsset.FaceRegion),
            label: new qinpel_cps_1.QinLabel("Região"),
        });
        this.qinNation = new qinpel_cps_1.QinButton({
            icon: new qinpel_cps_1.QinIcon(qinpel_cps_1.QinAsset.FaceGlobe),
            label: new qinpel_cps_1.QinLabel("País"),
        });
        this.qinLine1 = new qinpel_cps_1.QinLine({ items: [this.qinRegion, this.qinNation] });
