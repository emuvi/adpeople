...
function menuStartUp(menus) {
    const module = qinpel_cps_1.QinTool.qinpel.jobbed.getOption(ad_consts_1.AdOptions.MODULE);
    const scopes = qinpel_cps_1.QinTool.qinpel.jobbed.getOption(ad_consts_1.AdOptions.SCOPES);
    const filters = qinpel_cps_1.QinTool.qinpel.jobbed.getOption(ad_consts_1.AdOptions.FILTERS);
    if (module) {
...
class AdModel {
    ...
    tryConfirm() {
        ...
        this.register.qinpel.chief.talk.post("/reg/new", insert).then((_) => {
            this.clean();
            this.focusFirstField();
            this.register.qinpel.jobbed.statusInfo("Inserted: " + JSON.stringify(insert));
        });
    }
    tryCancel() {
        throw new Error("Method not implemented.");
...
},{"./qin-base-style":21,"./qin-tool":51,"qinpel-res":52}],23:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./qin-tool":51}],42:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
