...
class AdRegister extends qinpel_cps_1.QinColumn {
    constructor(expect, table) {
        ...
        this._viewVertical = new qinpel_cps_1.QinColumn();
        this._viewHorizontal = new qinpel_cps_1.QinRow();
