...
class AdRegister extends qinpel_cps_1.QinColumn {
    ...
    checkForMutations(runIfOk) {
        ...
        if (mutations) {
            let message = "There are mutations on this fields: " +
                mutations.join(", ") +
                ". Should we continue?";
