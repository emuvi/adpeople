...
class AdPeople extends qinpel_cps_1.QinColumn {
    constructor() {
        super();
        this.qinHello = new qinpel_cps_1.QinLabel("Hello, AdPeople!");
        this.qinFirst = new qinpel_cps_1.QinButton(null, new qinpel_cps_1.QinLabel("First"));
        this.qinSecond = new qinpel_cps_1.QinButton(null, new qinpel_cps_1.QinLabel("Second"));
        this.qinThird = new qinpel_cps_1.QinButton(null, new qinpel_cps_1.QinLabel("Third"));
